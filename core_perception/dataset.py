...
class CarlaDataset(Dataset):
    ...
    def _random_blur(self, image):
        ...
        Kernel 3×3 hoặc 5×5 được chọn ngẫu nhiên với xác suất bằng nhau.
    ...
    def __getitem__(self, idx):
        ...
        4. **Resize**: 200×66 px (đúng kích thước đầu vào của Nvidia CNN).
...
class CILCarlaDataset(CarlaDataset):
    ...
    * Vận tốc được chuẩn hoá về [0, 1] bằng cách chia cho
    ...
    def __getitem__(self, idx):
        ...
        augmentation, resize 200×66, chuyển YUV, transform).  Ngoài ra còn
