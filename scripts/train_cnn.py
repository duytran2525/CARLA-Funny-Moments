...
from core_perception.cnn_model import NvidiaCNNV2, CIL_NvidiaCNN
...
def main():
    parser = argparse.ArgumentParser(
        description="Huấn luyện CNN steering model cho CARLA tự lái."
    )
    parser.add_argument(
        '--mode', choices=['phase1', 'phase2'], default='phase1',
        help=(
            "Chế độ huấn luyện:\n"
    ...
    if args.mode == 'phase2':
        model_save_path = os.path.join(ROOT_DIR, 'models', 'cil_steering.pth')
